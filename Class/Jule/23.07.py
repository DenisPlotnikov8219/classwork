...
# b = int(input("Ведите 2 число: "))
#
# massiv = [[random.randint(a, b) for _ in range(cols)] for _ in range(rows)]
#
# print("Двумерный массив: ")
# for row in massiv:
#     print(row)
#
# total_sum = sum(sum(row) for row in massiv)
# total_elements = rows * cols
# average = total_sum / total_elements
#
# print(f"\nСреднее арифметическое всех элементов: {average:.2f}")
#
